            ...
            >
                <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
                        {/* Seção de Informações Bibliográficas */}
                        <div className="flex flex-col gap-4">
                            <h3 className="text-lg font-semibold text-primary-700 flex items-center gap-2">
                                <i className="pi pi-book text-blue-500"></i> Informações Bibliográficas
                            </h3>
                        ...
                        <div className="flex flex-col gap-4">
                            <h3 className="text-lg font-semibold text-primary-700 flex items-center gap-2">
                               <i className="pi pi-chart-bar text-orange-500"></i> Estoque e Aquisição
                            </h3>
